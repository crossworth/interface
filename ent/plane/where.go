...
func GarageID(v int) predicate.Plane {
	return predicate.Plane(func(s *sql.Selector) {
...
func GarageIDEQ(v int) predicate.Plane {
	return predicate.Plane(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldGarageID), v))
	})
}
...
func GarageIDNEQ(v int) predicate.Plane {
	return predicate.Plane(func(s *sql.Selector) {
...
func GarageIDIn(vs ...int) predicate.Plane {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func GarageIDNotIn(vs ...int) predicate.Plane {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func GarageIDIsNil() predicate.Plane {
	return predicate.Plane(func(s *sql.Selector) {
...
func GarageIDNotNil() predicate.Plane {
	return predicate.Plane(func(s *sql.Selector) {
...
func HasGarage() predicate.Plane {
	return predicate.Plane(func(s *sql.Selector) {
...
func HasGarageWith(preds ...predicate.Garage) predicate.Plane {
	return predicate.Plane(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
